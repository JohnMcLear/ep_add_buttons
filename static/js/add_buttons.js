...
exports.add_buttons = {
  ...
  ***/
  ...
  onButton() { // tell server to save pad content to a local text file and open a new window..
    exports.add_buttons.sendMessageToWriteTxtOfPadToFileSystem();
    // window.open(); Disabled for now.
  },
  sendMessageToWriteTxtOfPadToFileSystem() { // Tell file system to write the padId to the server filesytem
    const message = {};
